...
tap.test('Check uv validation', (test) => {
	...
	test.ok(!uv(Buffer.from([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80]))); // 1 * 16x
	test.ok(!uv(Buffer.from([0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x00]))); // 2 * 8x
	test.ok(!uv(Buffer.from([0xE0, 0xA0, 0x80, 0xE0, 0xA0, 0x80, 0xE0, 0xA0, 0x80, 0xE0, 0xA0, 0x80, 0xE0, 0xA0, 0x00, 0x00]))); // 3 * 5 + 1x
	test.ok(!uv(Buffer.from([0xE1, 0x80, 0x80, 0xE1, 0x80, 0x80, 0xE1, 0x80, 0x80, 0xE1, 0x80, 0x80, 0xE1, 0x80, 0x00, 0x00]))); // 3 * 5 + 1x
	test.ok(!uv(Buffer.from([0xED, 0x80, 0x80, 0xED, 0x80, 0x80, 0xED, 0x80, 0x80, 0xED, 0x80, 0x80, 0xED, 0x80, 0x00, 0x00]))); // 3 * 5 + 1x
	test.ok(!uv(Buffer.from([0xF0, 0x90, 0x80, 0x80, 0xF0, 0x90, 0x80, 0x80, 0xF0, 0x90, 0x80, 0x80, 0xF0, 0x90, 0x80, 0x00]))); // 4 * 4x
	test.ok(!uv(Buffer.from([0xF1, 0x80, 0x80, 0x80, 0xF1, 0x80, 0x80, 0x80, 0xF1, 0x80, 0x80, 0x80, 0xF1, 0x80, 0x80, 0x00]))); // 4 * 4x
	test.ok(!uv(Buffer.from([0xF4, 0x80, 0x80, 0x80, 0xF4, 0x80, 0x80, 0x80, 0xF4, 0x80, 0x80, 0x80, 0xF4, 0x80, 0x80, 0x00]))); // 4 * 4x

	test.ok(!uv(Buffer.from([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF]))); // 1 * 16x
	test.ok(!uv(Buffer.from([0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0x80, 0xC2, 0xFF]))); // 2 * 8x
	test.ok(!uv(Buffer.from([0xE0, 0xA0, 0x80, 0xE0, 0xA0, 0x80, 0xE0, 0xA0, 0x80, 0xE0, 0xA0, 0x80, 0xE0, 0xA0, 0xFF, 0x00]))); // 3 * 5 + 1x
	test.ok(!uv(Buffer.from([0xE1, 0x80, 0x80, 0xE1, 0x80, 0x80, 0xE1, 0x80, 0x80, 0xE1, 0x80, 0x80, 0xE1, 0x80, 0xFF, 0x00]))); // 3 * 5 + 1x
	test.ok(!uv(Buffer.from([0xED, 0x80, 0x80, 0xED, 0x80, 0x80, 0xED, 0x80, 0x80, 0xED, 0x80, 0x80, 0xED, 0x80, 0xFF, 0x00]))); // 3 * 5 + 1x
	test.ok(!uv(Buffer.from([0xF0, 0x90, 0x80, 0x80, 0xF0, 0x90, 0x80, 0x80, 0xF0, 0x90, 0x80, 0x80, 0xF0, 0x90, 0x80, 0xFF]))); // 4 * 4x
	test.ok(!uv(Buffer.from([0xF1, 0x80, 0x80, 0x80, 0xF1, 0x80, 0x80, 0x80, 0xF1, 0x80, 0x80, 0x80, 0xF1, 0x80, 0x80, 0xFF]))); // 4 * 4x
	test.ok(!uv(Buffer.from([0xF4, 0x80, 0x80, 0x80, 0xF4, 0x80, 0x80, 0x80, 0xF4, 0x80, 0x80, 0x80, 0xF4, 0x80, 0x80, 0xFF]))); // 4 * 4x
